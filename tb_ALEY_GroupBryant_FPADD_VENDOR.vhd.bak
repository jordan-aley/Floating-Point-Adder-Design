...
ENTITY tb_ALEY_GroupBryant_FPADD_VENDOR IS
END;

ARCHITECTURE TESTBENCH OF tb_ALEY_GroupBryant_FPADD_VENDOR IS
...
COMPONENT ALEY_GroupBryant_FPADD_VENDOR
PORT (	
	clk: in std_logic;
	reset: in std_logic;
	enR :in std_logic;
...
FILE exo_file : TEXT open read_mode is  	"ALEY_GroupBryant_FPADD_VENDOR_output.txt";   	-- Expected output (binary)
FILE out_file : TEXT open  write_mode is  	"ALEY_GroupBryant_FPADD_VENDOR_dataout.txt";
FILE xout_file : TEXT open  write_mode is 	"ALEY_GroupBryant_FPADD_VENDOR_TestOut.txt";
FILE hex_out_file : TEXT open  write_mode is    "ALEY_GroupBryant_FPADD_VENDOR_hex_out.txt";
...
InstALEY_GroupBryant_FPADD_VENDOR: ALEY_GroupBryant_FPADD_VENDOR port map (clk, reset, enR, enL, IN_A, IN_B, Sum_Q, RunOut);
...
CONFIGURATION cfg_tb_ALEY_GroupBryant_FPADD_VENDOR OF tb_ALEY_GroupBryant_FPADD_VENDOR IS
	FOR TESTBENCH
		FOR InstALEY_GroupBryant_FPADD_VENDOR: ALEY_GroupBryant_FPADD_VENDOR
			 use entity work.ALEY_GroupBryant_FPADD_VENDOR;		
		END FOR;
	END FOR;
END;